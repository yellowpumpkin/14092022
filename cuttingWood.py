...
class UI_Cutwood(QMainWindow):
    ...
    def displayTable2(self):
        ...
        # for i in range(0, 7):
        #     columnsize.setSectionResizeMode(i, QtWidgets.QHeaderView.Stretch)
        self.cuttingTable2.setEditTriggers(QAbstractItemView.NoEditTriggers|QAbstractItemView.DoubleClicked)
    ...
    def funcwithdrawWood(self):
        ...
        listInput = []
        for i in range(0, 7):
            listInput.append(self.cuttingTable2.item(self.cuttingTable2.currentRow(),i).text())
        print(listInput )
